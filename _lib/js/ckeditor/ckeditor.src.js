...
(function () {
            ...
            basePath: function () {
                ...
                if (!a)
                    for (var b = document.getElementsByTagName("script"), h = 0; h < b.length; h++) {
                        var c = b[h].src.match(/(^|.*[\\\/])ckeditor(?:_basic)?(?:_source)?.js(?:\?.*)?$/i);
                        if (c) {
                            a = c[1];
                            break
                        }
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {}, CKEDITOR.event.implementOn = function (b) {
        ...
        a.prototype = {
            getListenerIndex: function (a) {
                for (var b = 0, h = this.listeners; b < h.length; b++)
        ...
        return {
            ...
            on: function (a, d, h, c, j) {
                function i(b, g, n, o) {
                    ...
                    return d.call(h, b) === false ? false : b.data
                }

                function l() {
                    o.removeListener(a, d)
                }
                var n = b.call(this, a);
    ...
    (function () {
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                else if (typeof (d = arguments[b - 2]) == "boolean") {
                    c = arguments[b - 1];
                    b = b - 2
                }
                for (var f = 1; f < b; f++) {
            ...
            convertArrayToObject: function (a, b) {
                ...
                for (var c = 0, f = a.length; c < f; ++c) d[a[c]] = b;
                return d
            },
            fixDomain: function () {
                for (var a;;) try {
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend,
            c = function (a, b) {
                for (var e = CKEDITOR.tools.clone(a), d = 1; d < arguments.length; d++) {
                    var b = arguments[d],
                        c;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        ...
        getByAddress: function (b, c) {
            for (var a = this.$.documentElement, e =
                ...
                var d = b[e];
                if (c)
                    for (var h = -1, f = 0; f < a.childNodes.length; f++) {
                        var j = a.childNodes[f];
    ...
    CKEDITOR.dom.element.clearMarkers = function (b, c, a) {
        var e = c.getCustomData("list_marker_names"),
            ...
            h;
        for (h in e) c.removeCustomData(h);
    ...
    (function () {
        function b(a) {
            for (var b = 0, d = 0, h = c[a].length; d < h; d++) b = b + (parseInt(this.getComputedStyle(c[a][d]) || 0, 10) || 0);
            return b
        }
            ...
            mergeSiblings: function () {
                function a(a, b, c) {
                    if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a.isIdentical(b)) {
                            for (var j = c ? a.getLast() : a.getFirst(); f.length;) f.shift().move(a, !c);
                            b.moveChildren(a, !c);
                            b.remove();
            ...
            getDocumentPosition: function (a) {
                ...
                if (document.documentElement.getBoundingClientRect) {
                    var i =
                        ...
                        q = true;
                    if (CKEDITOR.env.ie) {
                        q = h.getDocumentElement().contains(this);
                        h = h.getBody().contains(this);
                        q = j && h || !j && q
                    }
                    if (q) {
                        b = i.left + (!j && l.scrollLeft || f.$.scrollLeft);
                        b = b - o;
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, h = 0; h < c.length; h++) {
                    ...
                    if (!(j in b))
                        ...
                        else if (f.specified || CKEDITOR.env.ie && f.nodeValue && j == "value") {
                        i = this.getAttribute(j);
                        if (i === null) i = f.nodeValue;
                        a.setAttribute(j, i)
                    }
                }
    ...
    (function () {
        function b(a, b) {
            ...
            if (!a && !this._.guardLTR) {
                ...
                this._.guardLTR = function (a, b) {
                    return (!b || !u.equals(a)) && (!m || !a.equals(m)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var E = n.type == CKEDITOR.NODE_ELEMENT ? n : n.getParent(),
                    A = n.type == CKEDITOR.NODE_ELEMENT ? o ? n.getChild(o - 1) : null : n.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !E.equals(a)) && (!A || !a.equals(A)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            if (this.current) d = this.current[h](false, p, k);
                ...
                if (a) d.type ==
                    ...
                    d = n;
                    if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(o))) d = k(n, true) === false ? null : n.getNextSourceNode(true, p, k)
                }
                d && k(d) === false && (d = null)
            }
            for (; d && !this._.end;) {
        ...
        CKEDITOR.dom.element.prototype.getBogus = function () {
            var a = this;
            do a = a.getPreviousSourceNode(); while (h(a) || d(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty));
    ...
    (function () {
        function b() {
            ...
            return function (g) {
                ...
                return g.type == CKEDITOR.NODE_TEXT && (g.hasAscendant("pre") || CKEDITOR.tools.trim(g.getText()).length) || g.type == CKEDITOR.NODE_ELEMENT && !g.is(h) ? false : true
            }
        }
        ...
        var e = function (a) {
            a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset
                ...
                for (c = j; c < h.length; c++) {
                    ...
                    if (!e[c] || s.$.parentNode != e[c].$.parentNode)
                        for (s = s.getPrevious(); s;) {
                            if (s.equals(e[c]) || s.equals(g)) break;
                            y = s.getPrevious();
                            if (b == 2) l.$.insertBefore(s.$.cloneNode(true), l.$.firstChild);
                            else {
                                s.remove();
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark2: function (a) {
                ...
                if (a) {
                    ...
                    for (; b.type == CKEDITOR.NODE_TEXT && (h = b.getPrevious()) && h.type == CKEDITOR.NODE_TEXT;) {
                        b = h;
                        d = d + h.getLength()
                    }
                    if (!p) {
                        ...
                        for (; c.type == CKEDITOR.NODE_TEXT && (h = c.getPrevious()) && h.type == CKEDITOR.NODE_TEXT;) {
                            c = h;
                            g = g + h.getLength()
                        }
                    }
            ...
            enlarge: function (a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    if (r.type == CKEDITOR.NODE_TEXT) {
                        ...
                        if (r && !(m = r.getPrevious())) f = r.getParent()
                    } else {
                        x &&
                    ...
                    for (; f || m;) {
                        if (f && !m) {
                            !i && f.equals(d) && (i = true);
                            if (c ? f.isBlockBoundary() : !g.contains(f)) break;
                            if (!j || f.getComputedStyle("display") != "inline") {
                                j = false;
                        ...
                        for (; m;) {
                            ...
                            if (m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious();
                                ...
                                if (m.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    /[^\s\ufeff]/.test(x) && (m = null);
                                    r = /[\s\ufeff]$/.test(x)
                                } else if ((m.$.offsetWidth > 0 || b && m.is("br")) && !m.data("cke-bookmark"))
                    ...
                    if (r.type == CKEDITOR.NODE_TEXT) {
                        ...
                        j = !(r && r.getLength());
                        if (r && !(m = r.getNext())) f = r.getParent()
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var y, t, w = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                            br: 1
                        } : null),
                        I = function (a) {
                            var b = w(a);
            ...
            getNextParagraph: function (b) {
                ...
                for (this._.nextNode = null; k;) {
                    ...
                    if (v) k.type == CKEDITOR.NODE_TEXT && a.test(k.getText()) && (v = 0);
                        ...
                        var m = k.getName();
                        if (k.isBlockBoundary(this.forceBrBreak && !p && {
                            br: 1
                        })) {
                            if (m == "br") v = 1;
                            else if (!i && !k.getChildCount() && m != "hr") {
                                d = k;
                                l = k.equals(n);
                                break
                            }
                    ...
                    if (i && !g)
                        for (; !k.getNext(h) && !l;) {
                            ...
                            if (m.isBlockBoundary(this.forceBrBreak && !p && {
                                ...
                                v = 0;
                                l || m.equals(n);
                                i.setEndAt(m, CKEDITOR.POSITION_BEFORE_END);
                                break
                            }
                            k = m;
                            v = 1;
    ...
    (function () {
                    ...
                    a: if (a.nothingRequired) f = true;
                        ...
                        if (e = a.requiredClasses) {
                            ...
                            for (f = 0; f < e.length; ++f)
                                if (CKEDITOR.tools.indexOf(h, e[f]) == -1) {
                                    f = false;
                                    break a
                                }
                        }
                    ...
                    if (!g.allClasses) {
                        ...
                        if (a)
                            if (a === true) b = true;
                                ...
                                for (var e = 0, h = b.length, p; e < h; ++e) {
                                    p = b[e];
                                    f[p] || (f[p] = a(p))
                                }
                                b = false
        ...
        function e(a) {
            ...
            return a._.filterFunction = function (g, f, e, h, k, m, t) {
                ...
                if (e = e && e[o]) {
                    i(g);
                    for (o = 0; o < e.length; ++o) p(a, g, e[o]);
                    l(g)
                }
                if (f) {
                    var o = g.name,
                    ...
                    if (e) {
                        o = 0;
                        for (v = e.length; o < v; ++o) b(e[o], g, f, true, m)
                    }
                    if (j) {
                        o = 0;
                        for (v = j.length; o < v; ++o) b(j[o], g, f, false, m)
                    }
                    if (!f.valid) {
                        h.push(g);
                        return true
                    ...
                    if (!f.allAttributes)
                        for (q in v)
                            if (!m[q])
                                if (E.test(q)) {
                                    if (q != (x = q.replace(/^data-cke-saved-/, "")) && !m[x]) {
                                        delete v[q];
                                        z = true
                                    }
                                } else {
        ...
        function f(a) {
            for (var b, c, g, d, f = {}, e = 1, a = x(a); b = a.match(y);) {
                if (c = b[2]) {
                    g = j(c, "styles");
                    d = j(c, "attrs");
                    c = j(c, "classes")
                ...
                if (b == "br") {
                    ...
                    b: {
                        ...
                        for (var f = 0, e = g.length, h; f < e; ++f) {
                            h = g[f];
                            if (h.type ==
                                CKEDITOR.NODE_ELEMENT && !d[h.name]) {
                                d = false;
                                break b
                            }
                        }
                    ...
                    if (d) {
                        ...
                        for (var f = d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || d.name == "body", p, e = g.length; e > 0;) {
                            h = g[--e];
                            if (f && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && A.$inline[h.name])) {
                                if (!p) {
                                ...
                                d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (h.type ==
                                    CKEDITOR.NODE_ELEMENT && !A[d.name][h.name]) && c.push({
                                    check: "el-up",
                                    el: h
                                })
                            }
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function (a, b, c) {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) p(a, f, h, d, b) && (m = true)
                        ...
                        a: {
                            ...
                            if (k)
                                for (o = 0; o < k.length; ++o)
                                    if ((t = g.match(k[o])) && t[0].length == g.length) {
                                        c = true;
                                        break a
                                    }
                            g = CKEDITOR.htmlParser.fragment.fromHtml(g);
                            g.children.length == 1 && (e = g.children[0]).type == CKEDITOR.NODE_ELEMENT && p(e, f, h, c, b);
                            c = !c.length
                        }
                        c || d.push(a)
                    }
                ...
                for (; t = a.pop();) {
                    o = t.el;
                    if (o.parent) switch (t.check) {
                    case "it":
                        A.$removeEmpty[o.name] && !o.children.length ? g(o, c, a) : n(o) || g(o, c, a);
                        break;
                    case "el-up":
                        o.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !A[o.parent.name][o.name] && g(o, c, a);
                        break;
                    case "parent-down":
            ...
            check: function (a, b, c) {
                ...
                var o = CKEDITOR.tools.clone(d),
                    m = [],
                    t;
                if (b !== false && (t = this._.transformations[d.name])) {
                    for (g = 0; g < t.length; ++g) p(this, d, t[g]);
                    l(d)
                }
                ...
                transform: function (a, b) {
                    if (typeof b == "string") a.name = b;
                        ...
                        for (e in d)
                            if (e == "class") {
                                c = a.classes.join("|");
                                for (h = d[e].split(/\s+/); p = h.pop();) c.indexOf(p) == -1 && a.classes.push(p)
                ...
                if (j === 0) n(true);
                    ...
                    var o = function (a, b) {
                        ...
                        if (--j <= 0) {
                            ...
                            var d = c[a];
                            delete c[a];
                            for (var f = 0; f < d.length; f++) d[f](a, g)
                        }, k = function (a) {
                            if (b[a]) o(a, true);
                            else {
                                var g = c[a] || (c[a] = []);
                                ...
                                if (!(g.length >
                                    ...
                                    if (e)
                                        if (CKEDITOR.env.ie) d.$.onreadystatechange = function () {
    ...
    CKEDITOR.resourceManager.prototype = {
        ...
        load: function (b, c, a) {
            ...
            for (var e = this.loaded, d = this.registered, h = [], f = {}, j = {}, i = 0; i < b.length; i++) {
                var l = b[i];
                if (l)
                    if (!e[l] && !d[l]) {
            ...
            CKEDITOR.scriptLoader.load(h, function (b,
                ...
                for (var h = 0; h < b.length; h++)
                    for (var g = f[b[h]], p = 0; p < g.length; p++) {
                        var i = g[p];
                        j[i] = this.get(i);
                        e[i] = 1
                    }
            ...
            var h = {}, f = function (a) {
                    b.call(this, a, function (a) {
                        ...
                        for (j in a) {
                            ...
                            if (q) {
                                q.split && (q = q.split(","));
                                for (o = 0; o < q.length; o++) h[q[o]] || b.push(q[o])
                            }
                        }
    ...
    (function () {
        function b(b, e, h) {
            ...
            if (e !== void 0) {
                ...
                if (!(h == CKEDITOR.ELEMENT_MODE_INLINE ? e.is(CKEDITOR.dtd.$editable) || e.is("textarea") : h == CKEDITOR.ELEMENT_MODE_REPLACE ? !e.is(CKEDITOR.dtd.$nonBodyContent) : 1)) throw Error('The specified element mode is not supported on element: "' + e.getName() + '".');
                this.element = e;
                this.elementMode = h;
        ...
        function c() {
            do var a = "editor" + ++q; while (CKEDITOR.instances[a]);
            return a
        }
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var k in c) {
                    ...
                    if (m && !a.lang[k]) {
                        ...
                        } if (!o.langEntries || !o.langEntries[i]) f.push(CKEDITOR.getUrl(o.path + "lang/" + i + ".js"));
                        else {
                            a.lang[k] = o.langEntries[i];
                            i = null
                        }
                    }
                    e.push(i);
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            ...
            _attachToForm: function () {
                ...
                if (b.is("textarea") && c) {
                    ...
                    c.on("submit", d);
                    if (!c.$.submit.nodeName && !c.$.submit.length) c.$.submit = CKEDITOR.tools.override(c.$.submit, function (a) {
                        return function (b) {
                            d(new CKEDITOR.dom.event(b));
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function (a) {
                for (var e, d, h = 0, f; e = this._.htmlPartsRegex.exec(a);) {
                    ...
                    } else if (d = e[2]) this.onComment(d)
                }
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, h, f) {
                ...
                if (p.length > 0)
                    for (var c = 0; c < p.length; c++) {
                        var d = p[c],
                            ...
                            e = u.name &&
                                CKEDITOR.dtd[u.name];
                        if ((!e || e[g]) && (!a || !f || f[a] || !CKEDITOR.dtd[a])) {
                            if (!b) {
                                i();
                                b = 1
                            }
            ...
            function o(a, b) {
                if ((a == g || a.name == "body") && f && (!a.name || CKEDITOR.dtd[a.name][f])) {
                    var c, d;
                    ...
                    if (d == "pre") E = true;
                        ...
                        for (;;) {
                            ...
                            if (!g.isUnknown && !u.isUnknown && !h[d])
                                ...
                                f = u.children;
                                (f = f[f.length - 1]) && f.name == "li" || n(f = new CKEDITOR.htmlParser.element("li"), u);
                                !g.returnPoint && (g.returnPoint = u);
                                u = f
                            } else if (d in CKEDITOR.dtd.$listItem && !q(d, f)) k.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
                            else if (f in c && !q(d, f)) {
                                !g.returnPoint &&
                                    (g.returnPoint = u);
                                u = u.parent
                            } else {
                                f in CKEDITOR.dtd.$inline && p.unshift(u);
                                if (u.parent) n(u, u.parent, 1);
                                else {
                                    g.isOrphan = 1;
                                    break
                                }
            ...
            k.onText = function (b) {
                if ((!u._.hasInlineStarted || v.length) && !E && !m) {
                    b = CKEDITOR.tools.ltrim(b);
                    if (b.length === 0) return
                }
                var d = u.name,
                    g = d ? CKEDITOR.dtd[d] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : e;
                if (!m && !g["#"] && d in c) {
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function (a, b, c) {
                ...
                for (var c = this.children, e, i = 0, l = c.length; i < l; i++) {
                    e = c[i];
        ...
        function b(b, c) {
            ...
            function o(a, b) {
                ...
                if (a.type ==
                    ...
                    if (CKEDITOR.env.ie && m && (!b || a.parent.name in t)) return true;
                    if (!m)
                ...
                return function (b) {
                    if (b.parent.type !=
                        ...
                        if ("data-cke-bogus" in c || "data-cke-eol" in c) delete c["data-cke-bogus"];
                            ...
                            var k = e(b);
                            !c && h(b.parent) ? j(b.parent, g(a)) : h(c) && (k && !h(k)) && f(c, g(a))
                        }
                    }
                }
            }(m);
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            ...
            for (a in CKEDITOR.dtd.$editable)
                for (var e = CKEDITOR.document.getElementsByTag(a), d = 0, h = e.count(); d < h; d++) {
                    b = e.getItem(d);
    ...
    (function () {
        function b(b) {
            ...
            if (CKEDITOR.env.gecko) {
                var m = g.block || g.blockLimit || g.root,
                    i = m && m.getLast(a);
                ...
                insertElement: function (b) {
                    ...
                    for (var c = this.editor, d = c.config.enterMode,
                        ...
                        if (!m.checkReadOnly()) {
                            ...
                            if (j)
                                ...
                                m.collapse(true);
                                x.remove()
                            } else m.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                            m.insertNode(n);
                            l ||
                                (l = n)
                        }
                    ...
                    if (l) {
                        ...
                        if (j)
                            ...
                            b = m.fixBlock(true, d == CKEDITOR.ENTER_DIV ? "div" : "p");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in {
                                ...
                                if (e = d(e)) {
                                    ...
                                    if ((k = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (j = k[c ? "getPrevious" : "getNext"](i)) && j.is("table")) {
                                        a.fire("saveSnapshot");
        ...
        var n = function () {
                ...
                for (var m = i[m.getName()], p = 0, j = a.getChildren(), n = j.count(), l = -1, v = -1, E = 0, A = g.contains(i.$list); p < n; ++p) {
                    ...
                    if (b(g)) {
                        ...
                        if (A && f in CKEDITOR.dtd.$list) k = k.concat(c(g, d));
                            ...
                            h = !! m[f];
                            if (f == "br" && g.data("cke-eol") && (!p || p == n - 1)) {
            ...
            function e(a, c, d, g) {
                ...
                if ((h = (new CKEDITOR.dom.walker(f)).next()) && b(h) && m[h.getName()] && (k = h.getPrevious()) && b(k) && !k.getParent().equals(a.startContainer) && d.contains(k) && g.contains(h) && h.isIdentical(k)) {
                    h.moveChildren(k);
                    h.remove();
                    e(a, c, d, g)
                }
            ...
            return function (m, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    ...
                    if (l.type == "text" && s.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) {
                        w = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", s.document);
                        s.insertNode(w);
                        s.setStartAfter(w)
                    }
                    ...
                    if (w) {
                        ...
                        for (h(I, F); w < I.length; w++) {
                            ...
                            if (B) y = w > 0;
                                ...
                                B = F.startPath();
                                if (!G.isBlock && (N = l.editor.config.enterMode != CKEDITOR.ENTER_BR && l.editor.config.autoParagraph !== false ? l.editor.config.enterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false) && !B.block && B.blockLimit && B.blockLimit.equals(F.root)) {
                                    N = L.createElement(N);
                                ...
                                if (P) {
                                    for (; B = P.pop();) F.insertNode(B);
                                    P = 0
                                } else F.insertNode(G.node); if (G.lastNotAllowed && w < I.length - 1) {
        ...
        CKEDITOR.dom.selection.prototype = {
            ...
            getRanges: function () {
                var a = o ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (; e > 0;) try {
                                i = h[t > 0 ? "previousSibling" : "nextSibling"];
                                if (i.nodeType == CKEDITOR.NODE_TEXT) {
                                    e = e - i.nodeValue.length;
                                    o = i
                                }
            ...
            getSelectedText: function () {
                ...
                var b = this.getNative(),
                    b = o ? b.type == "Control" ? "" : b.createRange().text : b.toString();
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (o) {
                            ...
                            if (n && n.type == CKEDITOR.NODE_ELEMENT && n.getName() in q && (!n.is("a") || !n.getText())) try {
                                l = n.$.createControlRange();
                                l.addElement(n.$);
                                l.select();
                                return
                            } catch (x) {}(b.startContainer.type ==
                            ...
                            for (d = 0; d < a.length; d++) {
                                if (d < a.length - 1) {
                                    ...
                                    j.setEnd(l.startContainer, l.startOffset);
                                    if (!j.collapsed) {
    ...
    (function () {
            ...
            if (a.collapsed) {
                ...
                for (n.getPosition(k) == CKEDITOR.POSITION_FOLLOWING && (n = 0); n;) {
                    ...
                    if (n.equals(k)) {
                        ...
                        for (var g = p(this, c), m = g.hasAttributes(), u = o.getCommonAncestor(), r = {}, s = {}, v = {}, z = {}, y, A, E; g && u;) {
                            if (u.getName() == d) {
            ...
            if (a.collapsed) {
                ...
                for (e = c; !e.equals(i);) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT &&
                        ...
                        e.getName() == this.element ? o.call(this, e) : k(e, m(this)[e.getName()]);
        ...
        function o(a) {
            var b = this._.definition,
                ...
                f;
            for (f in c)
                if (!((f == "class" || this._.definition.fullMatch) && a.getAttribute(f) != E(f, c[f]))) {
                    e = a.hasAttribute(f);
                    a.removeAttribute(f)
                }
            for (var h in b)
                if (!(this._.definition.fullMatch && a.getStyle(h) != E(h, b[h], true))) {
                    e = e || !! a.getStyle(h);
                    a.removeStyle(h)
                }
            k(a, d, r[a.getName()]);
        ...
        function q(a) {
            for (var b = m(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0;) o.call(this, c.getItem(d));
            for (var e in b)
                if (e != this.element) {
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function (a) {
                return (this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? c : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? e : null).call(this, a)
            },
            removeFromRange: function (b) {
                return (this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? a : this.type == CKEDITOR.STYLE_BLOCK ? f : this.type == CKEDITOR.STYLE_OBJECT ? d : null).call(this, b)
            },
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
        ...
        split: function (b) {
            var c = this.$.parentNode,
                ...
                e = this.getLength(),
                d = this.getDocument(),
                h = new CKEDITOR.dom.text(this.$.splitText(b), d);
        ...
        var c = {
            ...
            createBookmarks: function (a) {
                for (var c = [], d, h = 0; h < this.length; h++) {
                    c.push(d = this[h].createBookmark(a, true));
                    for (var f = h + 1; f < this.length; f++) {
                        this[f] = b(d, this[f]);
...
*/
    ...
    (function () {
        ...
        var c =
            c + (' onkeydown="return CKEDITOR.tools.callFunction({keydownFn},event);" onfocus="return CKEDITOR.tools.callFunction({focusFn},event);"  onmousedown="return CKEDITOR.tools.callFunction({mousedownFn},event);" ' + (CKEDITOR.env.ie ? 'onclick="return false;" onmouseup' : "onclick") + '="CKEDITOR.tools.callFunction({clickFn},this);return false;"><span class="cke_button_icon iconInline sz2 fwicon-{iconName}"'),
            ...
            function g(b) {
                ...
                if (m && m.length)
                    for (a = 0; a < m.length; a++) {
                        for (j = b = m[a];
                            (j = j.getNext()) && j.is && j.getName() in k;) CKEDITOR.env.ie && !b.getFirst(function (a) {
                            return t(a) && u(a)
